...
<section class="top-header loc-six-banner">
	<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
		<div class="carousel-indicators">
			<?php 	
				$fimage = get_field('location_single_page',$term->ID);
				$countSlide = 0;
		...
		<div class="carousel-inner">
			...
			?>
				...
				<div class="carousel-caption d-md-block">
					<h5><?php echo single_post_title(); ?></h5>
					<p><?php echo get_field('location_address_text',$term->ID); ?></p>
				</div>
			</div>
			<?php  $count++;}} ?>			
		</div>
...
<div class="loc-wrapper location-manchester-wrap">
			...
			<div class="row">
				<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
					<div class="bottom-sec">
						<?php $timing =  get_field('timing_and_contact',$term->ID); ?>
				...
				<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
					<div class="bottom-sec">
						...
						<div class="phone"><?php echo get_field('location_phone_number',$term->ID); ?></div>
	...
	<div class="map-sec location_mapNew">
		...
		<?php $map =  get_field('address',$term->ID);?>
		<iframe
            width="100%"
            height="450"
        ...
        <div class="map-content-box">
        	<div class="location"><?php echo single_post_title(); ?></div>
        	<p><?php echo get_field('location_address_text',$term->ID); ?></p>
        </div>
	</div>
</div>
