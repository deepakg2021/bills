...
class fdmOrderManager {
	...
	public function __construct() {
		...
		// post_status transition action
		add_action( 'fdm_order_received_' . FDM_ORDER_POST_TYPE, array( $this, 'send_admin_order_notification' ), 10, 2 );
	...
	public function send_admin_order_notification( $ID, $post ) {
