			...
			<?php foreach ( $fields as $field ) { ?>
				...
				<div class='fdm-ordering-custom-field-input'>
					...
					<?php elseif ( $field->type == 'text' ) : ?>
						...
						<input type='text' name='<?php echo $field->slug; ?>' />
	
					<?php elseif ( $field->type == 'textarea' ) : ?>
	
						<textarea name='<?php echo $field->slug; ?>'></textarea>
					...
					<?php elseif ( $field->type == 'checkbox' ) : ?>
						...
						<?php foreach ( $field_values as $value ) { ?>
							<input type='checkbox' name='<?php echo $field->slug; ?>[]' value='<?php echo sanitize_title( $value ); ?>' /><?php echo $value;?><br />
						<?php } ?>
